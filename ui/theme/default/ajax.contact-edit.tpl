...
<form class="form-horizontal" id="rform">
    ...
    <div class="form-group"><label class="col-lg-2 control-label" for="cid">{$_L['Type']}</label>
        ...
        <div class="col-lg-10">
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" class="i-checks" name="customer" value="Customer" {if $d->type == 'Customer,Supplier' || $d->type == 'Customer' } checked {/if}>
                    {$_L['Customer']}
                </label>
            </div>
            ...
            {if $config['suppliers'] eq '1'}
                <div class="checkbox">
                    <label>
                        <input type="checkbox" class="i-checks" name="supplier" value="Supplier"  {if $d->type == 'Customer,Supplier' || $d->type == 'Supplier' } checked {/if}>
                        {$_L['Supplier']}
                    </label>
                </div>
            {/if}

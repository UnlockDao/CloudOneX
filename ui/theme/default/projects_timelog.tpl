...
{block name="style"}
    <link rel="stylesheet" type="text/css" href="{$app_url}ui/lib/timepicker/jquery.timepicker.css" />
    <link rel="stylesheet" type="text/css" href="{$app_url}ui/lib/dp/dist/datepicker.min.css" />
    <link rel="stylesheet" type="text/css" href="{$app_url}ui/lib/spectrum/spectrum.css" />
...
{block name="script"}
    ...
    <script type="text/javascript" src="{$app_url}ui/lib/spectrum/spectrum.js?ver=2"></script>
    <script type="text/javascript" src="{$app_url}ui/lib/spectrum/i18n/en.js?ver=2"></script>
    <script type="text/javascript" src="{$app_url}ui/lib/validator/parsley.js?ver=2"></script>
    <script type="text/javascript" src="{$app_url}ui/lib/validator/i18n/en.js?ver=2"></script>
    <script type="text/javascript" src="{$app_url}ui/lib/modal.js?ver=2"></script>
    ...
    <script type="text/javascript" src="{$app_url}ui/lib/timepicker/jquery.timepicker.min.js"></script>

...
<head>
    ...
    <link href="{$theme}default/css/app.css?v={$file_build}_e" rel="stylesheet">
    ...
    <link href="{$theme}default/css/{$config['nstyle']}.css?v=11" rel="stylesheet">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav nav-highlight" id="side-menu">
                    ...
                    {if has_access($user->roleid,'projects') && ($config['projects'])}
                        <li {if $_application_menu eq 'projects'}class="active"{/if}><a href="{$_url}projects"><i class="fa fa-file-text-o"></i> <span class="nav-label">{$_L['Projects']}</span></a></li>
                    {/if}

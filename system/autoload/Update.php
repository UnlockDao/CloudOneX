...
class Update{
 ...
 ADD `signature_data_svg` text');
  ...
  PRIMARY KEY (`id`)
        ...
        {
            ORM::execute('ALTER TABLE `sys_transactions` ADD COLUMN `staff_id` int(11) NULL DEFAULT NULL AFTER `aid`');
        }


        if($file_build < 418)
        {
            ORM::execute('ALTER TABLE `clx_shared_preferences` CHANGE `value` `value` TEXT NULL DEFAULT NULL');
        }

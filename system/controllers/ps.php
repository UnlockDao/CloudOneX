...
<form class="form-horizontal" role="form" id="edit_form" method="post">
  ...
  <div class="form-group">
    <label for="sku" class="col-sm-2 control-label">'.$_L['SKU'].'</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="sku" value="'.$d->sku.'" id="sku">
      
    </div>
  </div>
  
  <div class="form-group">
    <label for="inventory" class="col-sm-2 control-label">'.$_L['Size'].'</label>
    <div class="col-sm-10">
      <div class="row">
      <div class="col-md-3">
      <input type="text" id="width" name="width" placeholder="'.$_L['Width'].'" class="form-control" value="'.$d->width.'" autocomplete="off">
</div>
      <div class="col-md-3">
      <input type="text" id="width" name="length" placeholder="'.$_L['Length'].'" class="form-control" value="'.$d->length.'" autocomplete="off">
</div>
      <div class="col-md-3">
      <input type="text" id="width" name="height" placeholder="'.$_L['Height'].'" class="form-control" value="'.$d->height.'" autocomplete="off">
</div>
      <div class="col-md-3">
      <input type="text" id="width" name="weight" placeholder="'.$_L['Weight'].'" class="form-control" value="'.$d->weight.'" autocomplete="off">
</div>
</div>
    </div>
  </div>
